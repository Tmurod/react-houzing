...
const navbar = [
  ...
  { id: 3, title: "Contacts", path: "/contacts", private: false, hidden: true, element: <ContactsPage /> },
  { id: 4, title: "signIn", path: "/signIn", private: false, hidden: true, element: <SignIn /> },
];
